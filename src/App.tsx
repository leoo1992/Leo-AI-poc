  ...
  return (
    <div className="pt-3 px-3 pb-5 h-screen flex flex-col justify-between">
      ...
      <div className="flex justify-end align-bottom items-end content-end w-12/12 h-4/6 chat chat-end">
        <div className="chat-bubble shadow-lg hover:shadow-xl mr-2 glass text-accent">
      ...
      >
       <label className="input input-bordered flex items-center justify-center self-center 
